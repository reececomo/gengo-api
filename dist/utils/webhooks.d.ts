import { GengoTier, GengoJobStatus, GengoLanguageCode, GengoLanguageUnit } from "./types";
/**
 ...
 */
export declare type GengoJobWebhookPayload = {
    /** Gengo Job ID */
    job_id: string;
    /** Gengo Order ID */
    order_id: string;
 ...
 * @see https://developers.gengo.com/v2/callback_urls/
 */
export declare type GengoCommentWebhookPayload = {
